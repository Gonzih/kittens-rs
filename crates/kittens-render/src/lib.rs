...
//! (`SPEC.md` revision 10: section 6 is the normative host surface; the K2R-0A
...
//! Xtensa-link scope. `FlightStarter`/`OwnedTransfer` sealing, bilateral seam
//! co-sign, target-side reactor execution, published-registry Xtensa
//! consumption, and board HIL/silicon delivery remain named gates.
//!
...
//! `esp32s3-sh8601-blocking` feature adds the exact-HAL adapter. Feature-off
//! core has no normal dependencies.
